  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={data} barGap={4} barCategoryGap="20%">
        ...
        <Bar dataKey="output_gst" name="Output GST" fill="#f43f5e" radius={[6, 6, 0, 0]} />
        <Bar dataKey="input_gst" name="Input GST (ITC)" fill="#10b981" radius={[6, 6, 0, 0]} />
        <Bar dataKey="net_liability" name="Net Liability" fill="#f59e0b" radius={[6, 6, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
